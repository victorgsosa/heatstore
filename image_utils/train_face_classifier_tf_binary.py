...
def main(base_dir, output_dir):
	...
	cp_callback = tf.keras.callbacks.ModelCheckpoint(checkpoint_path, 
                                                 ...
                                                 verbose=1)
	early = tf.keras.callbacks.EarlyStopping(monitor="val_acc", mode="max", patience=10)
	reduce_on_plateau = tf.keras.callbacks.ReduceLROnPlateau(monitor="val_acc", mode="max", factor=0.1, patience=3, verbose=1, min_delta=0.001)
